...
export default function HomeScreen() {
  ...
  const userCards: UserCardData[] = useMemo(() => {
    ...
    const manager1Issues = issues.filter((i) =>
      manager1Vessels.some((v) => v.id === i.vesselId),
    );
    ...
    const manager2Issues = issues.filter((i) =>
      manager2Vessels.some((v) => v.id === i.vesselId),
    );
    ...
    const crew1Tasks = maintenanceTasks.filter(
      (t) => t.assignedTo === "crew1" && t.status !== "completed",
    );
    ...
    const crew3Tasks = maintenanceTasks.filter(
      (t) => t.assignedTo === "crew3" && t.status !== "completed",
    );
              ...
              >
                ...
                <View style={styles.cardRight}>
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[styles.statusText, { color: card.statusColor }]}
                    >
                      {card.statusPill}
                    </Text>
                  </View>
